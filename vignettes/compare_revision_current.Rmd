...
mins_df <- lapply(hcp_cur, 
                  FUN = one_vs_all_dists, 
                  one_ch = hcp_rev, 
                  ch_name = "ch1")
# ch1_ratio <- list()
...
While osa = 0.25 seems like a reasonable cutoff (slightly less than the 0.01 percentile), we can examine a histogram of boostrapped mean distances to check how reasonable that value is:
...
Because the test with chapter 1 appears to have worked, 
